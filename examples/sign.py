...
from python_anvil.api_resources.mutations.create_etch_packet import (
    CreateEtchPacket,
)
...
def main():
    ...
    # Reference an existing PDF template from your Anvil account. The `id`
    # is your own name for this file, used by the signer fields below.
    ...
    # Fill the PDF with data before it is sent to any signers. Keys here
    # match the field IDs configured on the PDF template.
